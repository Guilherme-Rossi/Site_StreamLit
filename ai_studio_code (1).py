    ...
    <main>
        ...
        <section id="pricing" class="section fade-in">
            <div class="container">
                ...
                <p class="section-subtitle" style="display:flex; flex-direction:column;">Comece com um teste gratuito de 1 mês. Sem compromisso. Escolha o plano ideal para você após o período de avaliação.</p>
