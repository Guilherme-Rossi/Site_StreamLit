...
st.markdown("""
    <style>
        ...
        div[data-stale="false"] > iframe { padding: 0 !important; margin: 0 !important; }
...
<head>
    ...
    <style>
        ...
        :root {
            --dark-blue: #0d1b2a; --medium-blue: #1b263b; --light-blue: #415a77; --text-gray: #778da9; --white: #ffffff;
            --primary-gradient: linear-gradient(90deg, #3a86ff 0%, #8338ec 100%); --border-radius: 12px;
        ...
        body { margin: 0; font-family: 'Inter', sans-serif; line-height: 1.7; -webkit-font-smoothing: antialiased; }
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .logo { justify-self: start; font-size: 1.6rem; font-weight: 700; color: var(--dark-blue); }
        .nav-links { justify-self: center; list-style: none; display: flex; align-items: center; gap: 2.5rem; }
        ...
        .nav-actions { justify-self: end; display: flex; align-items: center; gap: 1.5rem; }
        ...
        .features-interactive-wrapper, .team-grid, .pricing-grid { display: grid; }
        .features-interactive-wrapper { grid-template-rows: auto 1fr; gap: 4rem; }
        .team-grid, .pricing-grid { grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2rem; }
        ...
        .feature-card, .team-card { background: var(--white); padding: 2.5rem 2rem; border-radius: var(--border-radius); text-align: left; box-shadow: var(--shadow-sm); border: 1px solid #e0e1dd; transition: all 0.3s ease; }
        .feature-card { cursor: pointer; }
        .feature-card:hover, .team-card:hover { transform: translateY(-8px); box-shadow: var(--shadow-md); }
        .feature-card .icon, .team-card .icon { margin-bottom: 1.5rem; background: var(--primary-gradient); width: 50px; height: 50px; border-radius: 50%; display: flex; align-items: center; justify-content: center; }
        .feature-card h3, .team-card h3 { font-size: 1.3rem; color: var(--dark-blue) !important; margin-bottom: 0.5rem; }
        .feature-card p, .team-card p { color: var(--text-gray) !important; }
        ...
        /* CSS dos mockups internos omitido para brevidade... */
    </style>
</head>
<body>
    <header>
    ...
    <main>
        <!-- Todo o conteúdo do site vai aqui... -->
        <section id="hero">
        ...
        <section id="for-who" class="section section-light">
            <div class="container">
                ...
                <div class="team-grid">
                    <div class="team-card animate-on-scroll" style="--delay: 0.3s;"><div class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg></div><h3>Marketing</h3><p>Planeje campanhas, gerencie calendários de conteúdo e colabore em criativos, tudo em um só lugar para manter os prazos em dia.</p></div>
                    <div class="team-card animate-on-scroll" style="--delay: 0.4s;"><div class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6"></polyline><polyline points="8 6 2 12 8 18"></polyline></svg></div><h3>Engenharia</h3><p>Organize sprints, rastreie bugs e gerencie o roadmap do produto com quadros Kanban flexíveis e integrações com o GitHub.</p></div>
                    <div class="team-card animate-on-scroll" style="--delay: 0.5s;"><div class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"></path><path d="M12 12v9"></path><path d="M8 17l4 4 4-4"></path></svg></div><h3>Startups</h3><p>Mova-se rápido e de forma organizada. Centralize ideias, tarefas e comunicação para escalar seu negócio com agilidade e foco.</p></div>
                </div>
            </div>
        </section>
...
# O scrolling=True é importante para que a rolagem da página principal controle o iframe.
