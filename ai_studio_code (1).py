...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .features-grid { order: 1; width: 100%; display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 2rem; }
        .feature-showcase { order: 2; margin-top: 4rem; width: 100%; max-width: 900px; height: 500px; background: #fff; border-radius: var(--border-radius); box-shadow: var(--shadow-md); border: 1px solid #e0e1dd; display: flex; justify-content: center; align-items: center; padding: 25px; }
        ...
        .features-grid:hover ~ .feature-showcase > #showcase-default { display: none; }
        #card-1:hover ~ .feature-showcase > #showcase-1 { display: grid; }
        #card-2:hover ~ .feature-showcase > #showcase-2 { display: block; }
        #card-3:hover ~ .feature-showcase > #showcase-3 { display: grid; }
        #card-4:hover ~ .feature-showcase > #showcase-4 { display: flex; justify-content: center; align-items: center; }
