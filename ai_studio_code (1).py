...
st.set_page_config(
    ...
    page_icon="doingworkiconefinal_icone.ico", # Certifique-se que este arquivo existe no seu diretório
    layout="wide",
    initial_sidebar_state="collapsed"
)

# 2. FORÇAR O TEMA BRANCO DO STREAMLIT (RESTAURADO CONFORME SEU PEDIDO)
st.markdown("""
    <style>
        /* Força o fundo principal do Streamlit para branco */
        .stApp {
