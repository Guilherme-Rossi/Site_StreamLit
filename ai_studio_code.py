...
# Configura a página para o modo wide para melhor aproveitar o espaço
st.set_page_config(layout="wide")

# O código HTML, CSS e JS combinado em uma única string
html_code = """
<!DOCTYPE html>
<html lang="pt-br">
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        body { font-family: 'Inter', sans-serif; background-color: var(--white); color: var(--text-gray); line-height: 1.7; -webkit-font-smoothing: antialiased; }
        ...
        header { padding: 1.5rem 0; position: fixed; top: 0; left: 0; width: 100%; z-index: 1000; transition: background-color 0.3s ease, box-shadow 0.3s ease, padding 0.3s ease; background-color: rgba(255, 255, 255, 0.95); backdrop-filter: blur(10px); box-shadow: var(--shadow-sm); }
        ...
        .dropdown-menu { display: none; position: absolute; top: 150%; left: 50%; transform: translateX(-50%); background: var(--white); border-radius: var(--border-radius); box-shadow: var(--shadow-md); list-style: none; padding: 0.5rem; width: 200px; z-index: 1; }
        .dropdown:hover .dropdown-menu { display: block; }
        .dropdown-menu a { display: block; padding: 0.75rem 1rem; border-radius: 8px; color: var(--medium-blue); }
        ...
        @media (max-width: 992px) {
            ...
            .mobile-menu-icon div { width: 25px; height: 3px; background-color: var(--dark-blue); margin: 5px 0; transition: all 0.3s ease; }
            .nav-links-mobile { display: none; } /* Escondido pois o JS não funcionará */
...
<body>
        ...
        <section id="features" class="section section-light fade-in">
             <div class="container">
                ...
                <div class="features-grid">
                    ...
                    <div class="feature-card">
                        <div class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg></div>
                    ...
                    <div class="feature-card">
                        <div class="icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="5" y="2" width="14" height="20" rx="2" ry="2"></rect><line x1="12" y1="18" x2="12.01" y2="18"></line></svg></div>
                ...
                <div class="pricing-grid">
                    <div class="pricing-card">
                        ...
                        <ul>
                            ...
                            <li><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>Gerenciamento de tarefas</li>
                    ...
                    <div class="pricing-card popular">
                        ...
                        <ul>
                            ...
                            <li><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>Tudo do plano Básico</li>
                    ...
                    <div class="pricing-card">
                        ...
                        <ul>
                            ...
                            <li><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>Tudo do plano Premium</li>
    ...
    <!-- A tag de script é mantida aqui para referência, mas o Streamlit não a executará. -->
    <script>
        // O CÓDIGO ABAIXO NÃO FUNCIONARÁ NO STREAMLIT
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Dropdown funcionando com clique
...
# Usa st.markdown para renderizar o código HTML/CSS
# unsafe_allow_html=True é necessário para renderizar HTML customizado
